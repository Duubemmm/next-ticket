  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Pending Tickets</h1>
          <p className="mt-2 text-gray-600">
            {tickets.length} {tickets.length === 1 ? "ticket" : "tickets"} awaiting response
          </p>
        </div>
        <Link
      ...
      {tickets.length === 0 ? (
        <div className="bg-white rounded-lg shadow border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You dont have any tickets waiting for a response.
          </p>
          <Link
